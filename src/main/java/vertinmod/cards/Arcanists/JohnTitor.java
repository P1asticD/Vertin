...
public class JohnTitor extends CustomCard {
    public static final String ID = ModHelper.makePath(JohnTitor.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/JohnTitor.png";

...
public class The_Fool extends CustomCard {
    public static final String ID = ModHelper.makePath(The_Fool.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/The_Fool.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(0) >= 1)
            Moxie.set(0, Math.min(Moxie.get(0) + magicNumber, Moxie_Max));
    }

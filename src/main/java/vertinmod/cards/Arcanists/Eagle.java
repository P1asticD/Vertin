...
public class Eagle extends CustomCard {
    public static final String ID = ModHelper.makePath(Eagle.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/Eagle.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(2) >= 1)
            Moxie.set(2, Math.min(Moxie.get(2) + magicNumber, Moxie_Max));
    }

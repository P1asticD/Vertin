...
public class Pickles extends CustomCard {
    public static final String ID = ModHelper.makePath(Pickles.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/Pickles.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(27) >= 1)
            Moxie.set(27, Math.min(Moxie.get(27) + magicNumber, Moxie_Max));
    }

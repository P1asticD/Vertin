...
public class Poltergeist extends CustomCard {
    public static final String ID = ModHelper.makePath(Poltergeist.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/Poltergeist.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(5) >= 1)
            Moxie.set(5, Math.min(Moxie.get(5) + magicNumber, Moxie_Max));
    }

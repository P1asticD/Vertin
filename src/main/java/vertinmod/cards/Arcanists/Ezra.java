...
public class Ezra extends CustomCard {
    public static final String ID = ModHelper.makePath(Ezra.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/Ezra.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(22) >= 1)
            Moxie.set(22, Math.min(Moxie.get(22) + magicNumber, Moxie_Max));
    }

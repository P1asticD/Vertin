...
public class Kanjira extends CustomCard {
    public static final String ID = ModHelper.makePath(Kanjira.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/Kanjira.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(25) >= 1)
            Moxie.set(25, Math.min(Moxie.get(25) + magicNumber, Moxie_Max));
    }

...
public class Sotheby extends CustomCard {
    public static final String ID = ModHelper.makePath(Sotheby.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/Sotheby.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(16) >= 1)
            Moxie.set(16, Math.min(Moxie.get(16) + magicNumber, Moxie_Max));
    }

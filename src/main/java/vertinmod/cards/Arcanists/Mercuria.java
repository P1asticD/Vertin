...
public class Mercuria extends CustomCard {
    public static final String ID = ModHelper.makePath(Mercuria.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "ModVertinResources/img/cards/Mercuria.png";
    ...
    public void onChoseThisOption(){
        if (Moxie.get(28) >= 1)
            Moxie.set(28, Math.min(Moxie.get(28) + magicNumber, Moxie_Max));
    }

...
public class PigeonPower_1 extends TwoAmountPower {
    public static final String POWER_ID = ModHelper.makePath("PigeonPower_1");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    private static final String NAME = powerStrings.NAME;
    private static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static int Count_Moxie_Use;

    public PigeonPower_1(AbstractCreature owner, int amount){
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public static void GetEnergy(){
        if (Count_Moxie_Use >= 2){
            AbstractDungeon.player.gainEnergy(Count_Moxie_Use / 2);
            Count_Moxie_Use %= 2;
        }
    }
